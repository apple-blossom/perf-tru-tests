...
class WidgetsMainLocators(object):
    ...
    JWT_FILED = (By.ID, "jwtToken")
    HOST_FILED = (By.ID, "host_addr")
    SAVE_BTN = (By.CSS_SELECTOR, ".btn.btn-success")


class WidgetsPrefcenterLocators(object):
    MY_PERMISSIONS = (By.XPATH, "//*[contains(text(),'My Permissions')]")
    PERMISSINS_TABLE = (By.CSS_SELECTOR, ".panel-body")
    PERMISSINS_TABLE_ROWS = (By.CSS_SELECTOR, "div.panel-group>div.panel.panel-default:nth-of-type(1) tr")
    ACCESS = (By.XPATH, "//*[contains(text(),'Access')]")
    RECTIFY = (By.XPATH, "//*[contains(text(),'Rectify')]")
    ERASE = (By.XPATH, "//*[contains(text(),'Erase')]")
    MY_DATA = (By.XPATH, "//*[contains(text(),'My Data')]")
